...
(define (mult . x) (apply apply-generic 'mult x))
...
(define (install-rectangular-package)
  ...
  (define (make-from-mag-ang r a)
    (cons (mult r (cos a)) (mult r (sin a))))
...
(define x (make-complex-from-real-imag (make-rational 3 2) (make-scheme-int 1)))
(define y (make-complex-from-real-imag (make-rational 4 2) (make-scheme-int 2)))
...
; for more advanced ops just need to make more of the Complex package
; use generic functions. It's abit fiddly to implement because Racket
; doesn't guarantee output types for any given math function so would
; need to cast the output of Racket math  primitives to conserve type
; of components of the Complex type.
